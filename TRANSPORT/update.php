...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="3" width="100%">
  <center><h1> modifications d'informations</h1></center>
  ...
  <tr>
                ...
                <td><a href="update.php?id_users=<?php echo $data['id_users'];?>"><button class='btn btn-primary' name='modification'> Modifier</button></a></td>
